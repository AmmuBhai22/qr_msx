...
class AdminSite:
    ...
    site_title = gettext_lazy("QR MANAGER")

    # Text to put in each page's <div id="site-name">.
    site_header = gettext_lazy("QR administration")

    # Text to put at the top of the admin index page.
    index_title = gettext_lazy("WELCOME TO QR MSX")
    ...
    def register(self, model_or_iterable, admin_class=None, **options):
        ...
        for model in model_or_iterable:
            ...
            if self.is_registered(model):
                ...
                if registered_admin.endswith(".ModelAdmin"):                    # Most likely registered without a ModelAdmin subclass.
    ...
    def get_urls(self):
        ...
        urlpatterns = [
            ...
            path(
                "r/<int:content_type_id>/<path:object_id>/",                wrap(contenttype_views.shortcut),
                name="view_on_site",
            ),
        ]
